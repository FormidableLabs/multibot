...
Repos.prototype._read = function (callback) {
  ...
  async.map(lookups, function (obj, cb) {
    self._repoObjs[obj.repo].contents(self._branchSrc, obj.file, function (err, data) {
      data = data || {};

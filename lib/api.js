...
var getTree = function (repo, treeSha, callback) {
  Github._request("GET", "/repos/" + repo + "/git/trees/" + treeSha, null, callback);
};
...
var postTree = function (repo, tree, baseTree, callback) { // eslint-disable-line max-params
  ...
  Github._request("POST", "/repos/" + repo + "/git/trees", data, callback);
};
...
var postCommit = function (repo, parent, tree, message, callback) {
  ...
  Github._request("POST", "/repos/" + repo + "/git/commits", data, callback);
};
...
var postRef = function (repo, ref, sha, callback) {
  ...
  Github._request("POST", "/repos/" + repo + "/git/refs/" + ref, data, callback);
};
